...
kdataset       <- "./exp/FE8150/dataset_7130.csv.gz"
...
kexperimento   <- "KA8442_4"

ksemilla_primos  <-  102191
ksemillerio  <- 100

kmax_bin           <-    31
klearning_rate     <-     0.0128524239805273
knum_iterations    <-   1466
knum_leaves        <-   782
kmin_data_in_leaf  <-  2112
kfeature_fraction  <-     0.44257442474569
